...
Manual (supervised) gating is widely used in cytometry (especially conventional flow cytometry (CFC)), whereby using graphical user interfaces of commercial software researchers draw hierarchial boolean gates around cell populations, switching markers to sequentially filtering down to smaller subsets of cells of interest. 

With the increase in markers (initially by mass cytometry (MC), recently by spectral flow cytometry (SFC)) and accompanying combinatorial combinations needing to be gated, algorithmic (unsupervised) methods have been developed to cluster cells on basis median fluorescent intensity (MFI) of individual markers. 
